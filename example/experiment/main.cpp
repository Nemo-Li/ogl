//
// Created by Nemo li on 2023/12/19.
//
...
int main() {
    ...
    // ------------------------------------
    Shader heightMapShader("../../../res/shader/8.3.cpuheight.vs", "../../../res/shader/8.3.cpuheight.fs");
    ...
    unsigned char *data = stbi_load("../../../res/image/iceland_heightmap.png", &width, &height, &nrChannels, 0);
    if (data) {
...
void processInput(GLFWwindow *window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        camera.ProcessKeyboard(EXP::FORWARD, deltaTime);
    if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
        camera.ProcessKeyboard(EXP::BACKWARD, deltaTime);
    if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
        camera.ProcessKeyboard(EXP::LEFT, deltaTime);
    if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
        camera.ProcessKeyboard(EXP::RIGHT, deltaTime);
}
