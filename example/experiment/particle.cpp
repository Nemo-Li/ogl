...
int main() {
    ...
    //创建游戏窗口
    GLFWwindow *game_glfw_window_ = glfwCreateWindow(1028, 1080, "particle", nullptr, nullptr);
    ...
    glfwMakeContextCurrent(game_glfw_window_);
    //开启垂直同步
    ...
    auto *shader = new EXP::Shader("../../../res/shader/particle.vert", "../../../res/shader/particle.frag");
    ...
    texture->load("image/circle_05.png");
    ...
    while (!glfwWindowShouldClose(game_glfw_window_)) {
        glfwPollEvents();
        // Clear the screen
        ...
        // Swap buffers
        glfwSwapBuffers(game_glfw_window_);
        glfwPollEvents();
    }
    ...
    glDeleteTextures(1, &texture->to_id);
