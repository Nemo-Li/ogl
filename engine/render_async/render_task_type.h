...
#ifndef OGL_RENDER_TASK_TYPE_H
#define OGL_RENDER_TASK_TYPE_H
...
public:
    ...
    //是否需要回传结果
    bool need_return_result_ = false;
    //是否设置好了回传结果
    bool return_result_set_ = false;
};
...
public:
    ...
    ~RenderTaskNeedReturnResult() override = default;
