...
GLFWwindow *RenderTaskConsumer::window_ = nullptr;
std::thread *RenderTaskConsumer::render_thread_ = nullptr;

void RenderTaskConsumer::Init(GLFWwindow *window) {
    window_ = window;
    render_thread_ = new std::thread(&RenderTaskConsumer::ProcessTask);
