...
#include "render_async/render_task_type.h"
...
void
RenderTaskProducer::ProduceRenderTaskCompileShader(const char *vertex_shader_source, const char *fragment_shader_source,
...
void RenderTaskProducer::ProduceRenderTaskUpdateTextureSubImage2D(unsigned int texture_handle, int x, int y, int width,
                                                                  int height,
...
void RenderTaskProducer::ProduceRenderTaskSetUniformMatrix4fv(unsigned int shader_program_handle,
                                                              const char *uniform_name, bool transpose,
                                                              glm::mat4 &matrix) {
...
void
RenderTaskProducer::ProduceRenderTaskBindVAOAndDrawElements(unsigned int vao_handle, unsigned int vertex_index_num) {
...
void RenderTaskProducer::ProduceRenderTaskSetStencilFunc(unsigned int stencil_func, int stencil_ref,
...
void RenderTaskProducer::ProduceRenderTaskSetStencilOp(unsigned int fail_op_, unsigned int z_test_fail_op_,
